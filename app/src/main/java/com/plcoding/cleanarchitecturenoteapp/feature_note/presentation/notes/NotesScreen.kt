    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = { notesViewModel.onEvent(NotesEvents.ToggleOrderSection) }) {
            ...
            AnimatedVisibility(
                ...
                OrderSection(
                    ...
                    onOrderChange = {
                        notesViewModel.onEvent(NotesEvents.Order(it))
                    })
            }
            ...
            LazyColumn(modifier = Modifier.fillMaxSize()) {
                items(state.notes) { note ->
                    NoteItem(note = note, modifier = Modifier
                        ...
                        //on delete click
                        notesViewModel.onEvent(NotesEvents.DeleteNote(note))
                        scope.launch {
                            ...
                            if (res == SnackbarResult.ActionPerformed) {
                                notesViewModel.onEvent(NotesEvents.RestoreNote)
                            }
                        }
                    }
                }
